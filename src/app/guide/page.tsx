      ...
      <section>
        ...
        <div className="space-y-4">
          ...
          <div className="border border-gray-200 rounded-lg p-4">
            ...
            <p className="text-gray-700">
              גלגל חירום קטן ורזה שנועד לנסיעה זמנית בלבד. <strong>מגבלות:</strong> מהירות מקסימלית 80 קמ&quot;ש, מרחק מקסימלי כ-80 ק&quot;מ. הפונה חייב להחליפו בגלגל רגיל בהקדם.
            </p>
          </div>
        </div>
      </section>
        ...
        <ol className="list-decimal list-inside text-gray-700 space-y-3 mr-4">
          ...
          <li>
            ...
            <ul className="list-disc list-inside mr-6 mt-2 text-gray-600 space-y-2">
              ...
              <li>
                <strong>&quot;העתק לינק לכונן&quot;</strong> — מעתיק רק את הקישור לטופס. מיועד לפונים עם מכשיר כשר — ניתן לשלוח ב-SMS
              </li>
            </ul>
          </li>
