      ...
      <section>
        ...
        <div className="space-y-4">
          ...
          <div className="border border-gray-200 rounded-lg p-4">
            ...
            <p className="text-gray-700">
              גלגל חירום קטן ורזה שנועד לנסיעה זמנית בלבד. <strong>מגבלות:</strong> מהירות מקסימלית 80 קמ"ש עקב קוד עומס שונה מהגלגלים המקוריים. הפונה חייב להחליפו בגלגל רגיל בהקדם.            </p>
          </div>
        </div>
      </section>
