...
function SearchPageContent() {
  ...
  // Tire-diameter calculator modal state
    ...
    <>
      ...
      <div style={styles.searchTypeContainer}>
        ...
        >
          ...
          <span>{ocrLoading ? 'מזהה רישיון...' : 'חיפוש לפי תמונת רישיון'}</span>
        </button>
      </div>
      <input
        ref={ocrInputRef}
                              ...
                              <div key={result.station.id} style={styles.resultStationGroup}>
                                ...
                                <div style={styles.resultWheelsList}>
                                  {result.wheels.filter(w => {
                                    ...
                                    // and those whose rim size is out of the fitment window entirely (>1" smaller,
                                    // or larger with rolled diameter beyond the "definitely won't fit" cutoff)
                                    if (w.is_available && !w.temporarily_unavailable) {
                                      ...
                                      if (checkRimFit(vehicleResult?.vehicle?.front_tire, wRim, w.tire_size, w.is_donut, manualRimSize) === 'mismatch') return false
                                    }
                                    return true
                                  }).map(wheel => {
                                    ...
                                    >
                                      ...
                                      {rimFit === 'smaller' && (
                                        <div style={{color: '#b45309', fontSize: '11px', display: 'flex', alignItems: 'center', gap: '3px', marginTop: '2px'}}>
                                          <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#b45309" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M10.29 3.86L1.82 18a2 2 0 0 0 1.71 3h16.94a2 2 0 0 0 1.71-3L13.71 3.86a2 2 0 0 0-3.42 0z"/><line x1="12" y1="9" x2="12" y2="13"/><line x1="12" y1="17" x2="12.01" y2="17"/></svg>
