    ...
    <>
      <style>{`
        ...
        @media (max-width: 768px) {
          .admin-header-inner { flex-direction: column !important; align-items: flex-start !important; }
          .admin-header-nav  { flex-wrap: wrap !important; }
        }
      `}</style>
      ...
      <div style={{
        ...
        <div className="admin-header-inner" style={{
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 14, flexShrink: 0 }}>
            ...
            <div>
              <h1 style={{ margin: 0, fontSize: '1.05rem', fontWeight: 800, color: '#f8fafc', whiteSpace: 'nowrap' }}>{title}</h1>
              {subtitle && <p style={{ margin: 0, fontSize: '0.75rem', color: '#64748b' }}>{subtitle}</p>}
            </div>
          </div>

          {/* Nav + logout */}
          <div className="admin-header-nav" style={{ display: 'flex', alignItems: 'center', gap: 6 }}>
